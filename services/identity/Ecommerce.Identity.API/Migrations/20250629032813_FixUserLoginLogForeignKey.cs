...
{
    /// <inheritdoc />
    public partial class FixUserLoginLogForeignKey : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Profile_NickName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Profile_AvatarUrl = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Profile_Birthday = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Profile_Gender = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
